...
|----------|-----------|------------------------------------------------------|----------------|
| Writing  | GT        | A point of view, argument or problem which you need to discuss. | ilt001         |
|          |           | Writing a letter to Respond to a situation.            | ilt004         |
|        |       AC    | A point of view, argument or problem which you need to discuss. | ilt002         |
|          |           | Describe some visual information in your own words.   | ilt003         |
